...
const pages: Array<{ url: string; images: { src: string; alt: string }[] }> = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: 'events/DSC00394.webp', alt: 'Smallbone brothers performing as for King and Country, by Cas Medlin' },
      { src: 'events/DSC01007(1) 2.webp', alt: 'Joe Smallbone (point up to heaven) of For King and Country performing on stage, by Cas Medlin' },
      ...
      { src: 'events/DSC00416.webp', alt: 'Smallbone brothers performing as for King and Country, by Cas Medlin' },
      { src: 'events/DSC01765.webp', alt: 'Worship at a Christian Concert, by Cas Medlin' },
      { src: 'events/AC1Q5KTQT7WuLx76AF9klA.webp', alt: 'For King and Country concert event, by Cas Medlin' },
      { src: 'events/DSC00490(1).webp', alt: 'For King and Country concert event, by Cas Medlin' },
      { src: 'events/Qtb5X8M_ToWbGhDqME-2Hg.webp', alt: 'For King and Country concert event, by Cas Medlin' },
      { src: 'events/vEJdCLCrTqeKmRr26izmybg.webp', alt: 'For King and Country concert event, by Cas Medlin' },
    ],
  },
  {
    url: '/pets',
